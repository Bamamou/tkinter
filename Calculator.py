...
root.iconphoto(True, PhotoImage(file='Roses.png'))
...
button_e =Button(root, text="=", padx=40, pady=20, command=lambda: button_equal(), bg="green")
button_c =Button(root, text="C", padx=40, pady=20, command=lambda: button_clear(), font=("times new rman", 10, 'bold'), fg='blue')
